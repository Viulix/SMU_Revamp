...
{
    public sealed class PulseSpotMeasurementPlan : MeasurementPlanBase
    {
        public override string Name => "Pulse Spot";
        public override string Description => "Performs a single-point pulsed measurement of current at a specified pulse voltage.";
                        public double PlotBeRatio => 3.0;
